...
public class MongoConnection
{
    ...
    private readonly string mongoPort = Environment.GetEnvironmentVariable("MONGO_PORT") ?? "27017";
    private readonly string mongoUser = Environment.GetEnvironmentVariable("MONGO_USER") ?? "root";
    private readonly string mongoDB = Environment.GetEnvironmentVariable("MONGO_DB") ?? "root";
    private readonly string mongoPsw = Environment.GetEnvironmentVariable("MONGO_PASSWORD") ?? "Pass@word1";
