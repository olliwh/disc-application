...
public class Neo4JConnection
{
    ...
    private readonly string Database = Environment.GetEnvironmentVariable("NEO4J_DATABASE") ?? "neo4j";
    private readonly string Neo4jUrl = Environment.GetEnvironmentVariable("Neo4j__Uri") ?? "bolt://localhost:7687";
    private readonly string Neo4jPassword = Environment.GetEnvironmentVariable("NEO4J_PASSWORD") ?? "12345678";
    private readonly string Neo4jUser = Environment.GetEnvironmentVariable("NEO4J_USER") ?? "neo4j";
